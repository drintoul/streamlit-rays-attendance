...
st.markdown(f"playing the {data['opponent']} while ranked #{data['div_rank']} in AL East being {data['games_behind']} games behind division leader.", unsafe_allow_html=True)
